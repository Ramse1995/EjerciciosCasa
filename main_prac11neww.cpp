...
//Accion de Animacion comienza con la letra l										
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	pintaTexto(-11, 12.0, -14.0, (void *)font, "Practica 11 Mano Animada, piedra ,Papel O Tijera, Like");
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Practica 11 Mano Animada, piedra ,Papel O Tijera, Like"); // Nombre de la Ventana
