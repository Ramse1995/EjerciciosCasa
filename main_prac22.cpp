...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	glColor3f(1.0f, 0.0f, 0.0f);
	glEnd();*/
glBegin(GL_QUADS);// parte baja piramide
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-17.0f, -17.0f, 0.0f);
glVertex3f(-1.0f, -17.0f, 0.0f);
glVertex3f(-1.0f, -16.0f, 0.0f);
glVertex3f(-17.0f, -16.0f, 0.0f);
glEnd();
glBegin(GL_QUADS);//borde piramide
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-18.0f, -17.0f, 0.0f);
glVertex3f(-17.0f, -17.0f, 0.0f);
glVertex3f(-17.0f, -14.0f, 0.0f);//punto de interes
glVertex3f(-18.0f, -14.0f, 0.0f);

glEnd();
glBegin(GL_QUADS);//borde piramide
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-17.0f, -14.0f, 0.0f);
glVertex3f(-16.0f, -14.0f, 0.0f);
glVertex3f(-16.0f, -12.0f, 0.0f);//punto de interes
glVertex3f(-17.0f, -12.0f, 0.0f);

glEnd();
glBegin(GL_QUADS);//borde piramide
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-16.0f, -12.0f, 0.0f);
glVertex3f(-15.0f, -12.0f, 0.0f);
glVertex3f(-15.0f, -10.0f, 0.0f);//punto de interes
...
glVertex3f(-14.0f, -8.0f, 0.0f);//punto de interes
...
glBegin(GL_QUADS);//borde piramide
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-14.0f, -8.0f, 0.0f);
glVertex3f(-13.0f, -8.0f, 0.0f);
glVertex3f(-13.0f, -6.0f, 0.0f);//punto de interes
...
glVertex3f(-12.0f, -4.0f, 0.0f);//punto de interes
...
glVertex3f(-11.0f, -2.0f, 0.0f);//punto de interes
...
glVertex3f(-10.0f, -2.0f, 0.0f);
glVertex3f(-10.0f, 0.0f, 0.0f);//punto de interes
...
glVertex3f(-8.0f, 1.0f, 0.0f);//punto de interes
...
glVertex3f(-7.0f, -2.0f, 0.0f);//punto de interes
glVertex3f(-8.0f, -2.0f, 0.0f);
...
glVertex3f(-6.0f, -4.0f, 0.0f);//punto de interes
glVertex3f(-7.0f, -4.0f, 0.0f);
...
glVertex3f(-6.0f, -4.0f, 0.0f);
glVertex3f(-5.0f, -4.0f, 0.0f);
glVertex3f(-5.0f, -6.0f, 0.0f);//punto de interes
...
glVertex3f(-4.0f, -8.0f, 0.0f);//punto de interes
...
glVertex3f(-3.0f, -10.0f, 0.0f);//punto de interes
...
glVertex3f(-2.0f, -12.0f, 0.0f);//punto de interes
...
glVertex3f(-1.0f, -14.0f, 0.0f);//punto de interes
...
glVertex3f(0.0f, -17.0f, 0.0f);//punto de interes
glVertex3f(-1.0f, -17.0f, 0.0f);
...
glVertex3f(-13.0f, -11.0f, 0.0f);//punto de interes
glVertex3f(-14.0f, -11.0f, 0.0f);
...
glVertex3f(-11.0f, -12.0f, 0.0f);//punto de interes
glVertex3f(-13.0f, -12.0f, 0.0f);

glEnd();

glBegin(GL_QUADS);//borde piramide
glVertex3f(-11.0f, -12.0f, 0.0f);
glVertex3f(-7.0f, -12.0f, 0.0f);
glVertex3f(-7.0f, -13.0f, 0.0f);//punto de interes
glVertex3f(-11.0f, -13.0f, 0.0f);
...
glVertex3f(-5.0f, -11.0f, 0.0f);//punto de interes
glVertex3f(-7.0f, -11.0f, 0.0f);
...
glVertex3f(-4.0f, -11.0f, 0.0f);
glVertex3f(-4.0f, -9.0f, 0.0f);//punto de interes
...
glVertex3f(-7.0f, -8.0f, 0.0f);//punto de interes
glVertex3f(-5.0f, -8.0f, 0.0f);
...
glVertex3f(-11.0f, -7.0f, 0.0f);//punto de interes
...
glVertex3f(-13.0f, -9.0f, 0.0f);//punto de interes
glVertex3f(-13.0f, -8.0f, 0.0f);


glEnd();
glBegin(GL_POLYGON);//ojo
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-8.0f, -8.0f, 0.0f);
glVertex3f(-8.0f, -10.0f, 0.0f);
glVertex3f(-9.0f, -10.0f, 0.0f);//punto de interes
...
glBegin(GL_POLYGON);//ojo
glColor3f(0.0f, 0.0f, 0.0f);
glVertex3f(-9.0f, -10.0f, 0.0f);
glVertex3f(-10.0f, -10.0f, 0.0f);
glVertex3f(-10.0f, -9.0f, 0.0f);//punto de interes
...
glVertex3f(-11.0f, -8.0f, 0.0f);//punto de interes
glVertex3f(-11.0f, -10.0f, 0.0f);
...
glVertex3f(-8.0f, -11.0f, 0.0f);//punto de interes
glVertex3f(-8.0f, -10.0f, 0.0f);
...
glVertex3f(-10.0f, -2.0f, 0.0f);
glVertex3f(-8.0f, -2.0f, 0.0f);
glVertex3f(-8.0f, 0.0f, 0.0f);//punto de interes
glVertex3f(-10.0f, 0.0f, 0.0f);
