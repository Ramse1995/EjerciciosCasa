...
GLfloat u_ambient[] = { 0.133337, 0.9001, 0.713, 1.0 };					// Color background
GLfloat u_diffuse[] = { 0.133337, 0.9001, 0.713, 1.0 };					// Object Color main
GLfloat u_specular[] = { 0.133337, 0.9001, 0.713, 1.0 };				// Specular color
GLfloat u_shininess[] = { 100.0 };

GLfloat ne_ambient[] = { 0.145, 0.125, 0.835, 1.0 };					// Color background
GLfloat ne_diffuse[] = { 0.145, 0.125, 0.835, 1.0 };					// Object Color main
GLfloat ne_specular[] = { 0.145, 0.125, 0.835, 1.0 };				// Specular color
GLfloat ne_shininess[] = { 100.0 };
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, ju_ambient);
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, sa_ambient);
	...
	glTranslatef(21, 0, 0);
	glMaterialfv(GL_FRONT, GL_AMBIENT, u_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, u_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, u_specular);
	glMaterialfv(GL_FRONT, GL_SHININESS, u_shininess);
	glutSolidSphere(0.5, 30, 30);
	glPushMatrix();
	glRotatef(luna, 1, 0, 0);//Traslacion luna
	glTranslatef(2, 0, 0);
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, ne_ambient);
	glMaterialfv(GL_FRONT, GL_DIFFUSE, ne_diffuse);
	glMaterialfv(GL_FRONT, GL_SPECULAR, ne_specular);
	glMaterialfv(GL_FRONT, GL_SHININESS, ne_shininess);
	glutSolidSphere(0.5, 30, 30);
	glPushMatrix();
	glRotatef(luna, 1, 0, 0);//Traslacion luna
	glTranslatef(2, 0, 0);
